...
STOP_LOSS_PCT = float(os.getenv('STOP_LOSS_PCT', '0.001'))  # 0.1% stop loss (more conservative)
TRAILING_STOP = os.getenv('TRAILING_STOP', 'True').lower() == 'true'
TRAILING_STOP_PCT = float(os.getenv('TRAILING_STOP_PCT', '0.001'))  # 0.1% trailing stop
...
TAKE_PROFIT_PCT = float(os.getenv('TAKE_PROFIT_PCT', '0.002'))  # 0.2% fixed take profit
